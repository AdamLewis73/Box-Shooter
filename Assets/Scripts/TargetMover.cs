	...
	void Update () {
		...
		switch(motionState) {
			...
			case motionDirections.Horizontal:
				...
				gameObject.transform.Translate(Vector3.right * slower * Mathf.Cos(Time.timeSinceLevelLoad) * motionMagnitude);
				break;
			case motionDirections.Vertical:
				// move up and down over time
			gameObject.transform.Translate(Vector3.up * slower * Mathf.Cos(Time.timeSinceLevelLoad) * motionMagnitude);
				break;
		}
	}
}
